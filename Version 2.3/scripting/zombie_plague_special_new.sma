...
Array:zombie_pain, Array:nemesis_pain, Array:assassin_pain, Array:predator_pain, Array:bombardier_pain, Array:dragon_pain, Array:zombie_die, Array:zombie_fall, Array:zombie_miss_wall, Array:zombie_hit_normal, Array:zombie_hit_stab, g_ambience_rain,
...
g_ambience_sounds[MAX_AMBIENCE_SOUNDS], Array:sound_ambience_infection, Array:sound_ambience_nemesis, Array:sound_ambience_survivor, Array:sound_ambience_swarm, Array:sound_ambience_plague, Array:sound_ambience_infection_dur, Array:sound_ambience_nemesis_dur,
Array:sound_ambience_survivor_dur, Array:sound_ambience_swarm_dur, Array:sound_ambience_plague_dur, Array:g_primary_items, Array:g_secondary_items, Array:g_additional_items, Array:g_primary_weaponids, Array:g_secondary_weaponids, 
...
Array:sound_sniper, Array:sound_ambience_sniper, Array:sound_ambience_sniper_dur, Array:model_assassin, Array:g_modelindex_assassin, model_vknife_assassin[64],
Array:sound_assassin, Array:sound_ambience_assassin, Array:sound_ambience_assassin_dur, Array:sound_lnj, Array:sound_ambience_lnj, Array:sound_ambience_lnj_dur,
Array:model_berserker, Array:g_modelindex_berserker, model_vknife_berserker[64], model_pknife_berserker[64], Array:sound_berserker, Array:sound_ambience_berserker, Array:sound_ambience_berserker_dur, 
Array:model_predator, Array:g_modelindex_predator, model_vknife_predator[64], Array:sound_predator, Array:sound_ambience_predator, Array:sound_ambience_predator_dur, 
Array:model_wesker, Array:g_modelindex_wesker, model_vdeagle_wesker[64], model_pdeagle_wesker[64], Array:sound_wesker, Array:sound_ambience_wesker, Array:sound_ambience_wesker_dur, 
Array:model_bombardier, Array:g_modelindex_bombardier, model_vknife_bombardier[64], Array:sound_bombardier, Array:sound_ambience_bombardier, Array:sound_ambience_bombardier_dur,
Array:model_dragon, Array:g_modelindex_dragon, model_vknife_dragon[64], Array:sound_dragon, Array:sound_ambience_dragon, Array:sound_ambience_dragon_dur,
Array:model_spy, Array:g_modelindex_spy, model_vm3_spy[64], model_pm3_spy[64], Array:sound_spy, Array:sound_ambience_spy, Array:sound_ambience_spy_dur

// CVAR pointers
new cvar_lighting, cvar_zombiefov, cvar_removemoney, cvar_thunder, cvar_deathmatch, cvar_customnvg, cvar_hitzones, cvar_flashsize, cvar_ammodamage, cvar_zombiearmor, 
...
cvar_extraweapons, cvar_extranvision, cvar_nvggive, cvar_preventconsecutive, cvar_botquota, cvar_buycustom, cvar_fireslowdown, cvar_sniperfraggore, cvar_nemfraggore, cvar_flaresize2, cvar_humansurvive, cvar_antidote_minzms,
cvar_extrainfbomb, cvar_knockback, cvar_fragsinfect, cvar_fragskill, cvar_humanarmor, cvar_zombiesilent, cvar_removedropped,
...
cvar_lnjnemhpmulti, cvar_lnjsurvhpmulti,  cvar_lnjratio, cvar_lnjrespsurv, cvar_lnjrespnem , cvar_flashsize2, cvar_frozenhit, cvar_aiminfo, cvar_human_unstuck,
...
public plugin_precache()
{
	...
	register_plugin("Zombie Plague Special", "2.2", "MeRcyLeZZ | @bdul! | [P]erfect [S]crash")
	...
	sound_ambience_infection = ArrayCreate(64, 1)
	sound_ambience_nemesis = ArrayCreate(64, 1)
	sound_ambience_survivor = ArrayCreate(64, 1)
	sound_ambience_swarm = ArrayCreate(64, 1)
	sound_ambience_plague = ArrayCreate(64, 1)
	sound_ambience_infection_dur = ArrayCreate(64, 1)
	sound_ambience_nemesis_dur = ArrayCreate(64, 1)
	sound_ambience_survivor_dur = ArrayCreate(64, 1)
	sound_ambience_swarm_dur = ArrayCreate(64, 1)
	sound_ambience_plague_dur = ArrayCreate(64, 1)
	...
	sound_ambience_sniper = ArrayCreate(64, 1)
	sound_ambience_sniper_dur = ArrayCreate(64, 1)
	sound_lnj = ArrayCreate(64, 1)
	sound_ambience_lnj = ArrayCreate(64, 1)
	sound_ambience_lnj_dur = ArrayCreate(64, 1)
	...
	sound_ambience_assassin = ArrayCreate(64, 1)
	sound_ambience_assassin_dur = ArrayCreate(64, 1)
	model_berserker = ArrayCreate(32, 1)
	g_modelindex_berserker = ArrayCreate(1, 1)
	sound_berserker = ArrayCreate(64, 1)
	sound_ambience_berserker = ArrayCreate(64, 1)
	sound_ambience_berserker_dur = ArrayCreate(64, 1)
	sound_ambience_predator = ArrayCreate(64, 1)
	sound_ambience_predator_dur = ArrayCreate(64, 1)
	model_wesker = ArrayCreate(32, 1)
	g_modelindex_wesker = ArrayCreate(1, 1)
	sound_wesker = ArrayCreate(64, 1)
	sound_ambience_wesker = ArrayCreate(64, 1)
	sound_ambience_wesker_dur = ArrayCreate(64, 1)
	sound_ambience_bombardier = ArrayCreate(64, 1)
	sound_ambience_bombardier_dur = ArrayCreate(64, 1)
	sound_ambience_dragon = ArrayCreate(64, 1)
	sound_ambience_dragon_dur = ArrayCreate(64, 1)
	model_spy = ArrayCreate(32, 1)
	g_modelindex_spy = ArrayCreate(1, 1)
	sound_spy = ArrayCreate(64, 1)
	sound_ambience_spy = ArrayCreate(64, 1)
	sound_ambience_spy_dur = ArrayCreate(64, 1)
	...
	for (i = 0; i < ArraySize(model_spy); i++)
	{
		ArrayGetString(model_spy, i, buffer, charsmax(buffer))
		format(buffer, charsmax(buffer), "models/player/%s/%s.mdl", buffer, buffer)
		ArrayPushCell(g_modelindex_spy, engfunc(EngFunc_PrecacheModel, buffer))
		formatex(tmodel_buffer, charsmax(tmodel_buffer), "models/player/%s/%sT.mdl", buffer, buffer)
		if (file_exists(tmodel_buffer)) engfunc(EngFunc_PrecacheModel, tmodel_buffer)
		if (g_force_consistency == 1) force_unmodified(force_model_samebounds, {0,0,0}, {0,0,0}, buffer)
		if (g_force_consistency == 2) force_unmodified(force_exactfile, {0,0,0}, {0,0,0}, buffer)
	...
	engfunc(EngFunc_PrecacheModel, model_vm3_spy)
	engfunc(EngFunc_PrecacheModel, model_pm3_spy)
	...
	frostsprite = engfunc(EngFunc_PrecacheModel, "sprites/frost_explode.spr")
	...
	for (i = 0; i < ArraySize(sound_spy); i++)
	{
		ArrayGetString(sound_spy, i, buffer, charsmax(buffer))
		if (equal(buffer[strlen(buffer)-4], ".mp3")) {
			format(buffer, charsmax(buffer), "sound/%s", buffer)
			engfunc(EngFunc_PrecacheGeneric, buffer)
		}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_INFECTION]) {
		for (i = 0; i < ArraySize(sound_ambience_infection); i++) {
			ArrayGetString(sound_ambience_infection, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_NEMESIS])	{
		for (i = 0; i < ArraySize(sound_ambience_nemesis); i++) {
			ArrayGetString(sound_ambience_nemesis, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_SURVIVOR]) {
		for (i = 0; i < ArraySize(sound_ambience_survivor); i++)	{
			ArrayGetString(sound_ambience_survivor, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_SWARM]) {
		for (i = 0; i < ArraySize(sound_ambience_swarm); i++) {
			ArrayGetString(sound_ambience_swarm, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_PLAGUE]) {
		for (i = 0; i < ArraySize(sound_ambience_plague); i++) {
			ArrayGetString(sound_ambience_plague, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_SNIPER]) {
		for (i = 0; i < ArraySize(sound_ambience_sniper); i++)
		{
			ArrayGetString(sound_ambience_sniper, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_ASSASSIN]) {
		for (i = 0; i < ArraySize(sound_ambience_assassin); i++) {
			ArrayGetString(sound_ambience_assassin, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_LNJ]) {
		for (i = 0; i < ArraySize(sound_ambience_lnj); i++) {
			ArrayGetString(sound_ambience_lnj, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_BERSERKER]) {
		for (i = 0; i < ArraySize(sound_ambience_berserker); i++) {
			ArrayGetString(sound_ambience_berserker, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_PREDATOR]) {
		for (i = 0; i < ArraySize(sound_ambience_predator); i++) {
			ArrayGetString(sound_ambience_predator, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_WESKER]) {
		for (i = 0; i < ArraySize(sound_ambience_wesker); i++) {
			ArrayGetString(sound_ambience_wesker, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_BOMBARDIER]) {
		for (i = 0; i < ArraySize(sound_ambience_bombardier); i++) {
			ArrayGetString(sound_ambience_bombardier, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_SPY]) {
		for (i = 0; i < ArraySize(sound_ambience_spy); i++) {
			ArrayGetString(sound_ambience_spy, i, buffer, charsmax(buffer))
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_DRAGON]) {
		for (i = 0; i < ArraySize(sound_ambience_dragon); i++) {
			ArrayGetString(sound_ambience_dragon, i, buffer, charsmax(buffer))
...
public plugin_init()
{
	...
	register_cvar("zombie_plague_special", "2.3", FCVAR_SERVER|FCVAR_SPONLY)
	set_cvar_string("zombie_plague_special", "2.3")
...
public fw_PlayerKilled(victim, attacker, shouldgib)
{
	...
	if (!selfkill)
	{
		...
		if (g_zm_special[attacker] > 0 && get_pcvar_num(cvar_zm_ignore_frags[g_zm_special[attacker]]) || g_hm_special[attacker] > 0 && get_pcvar_num(cvar_hm_ignore_frags[g_hm_special[attacker]]))
			RemoveFrags(attacker, victim)
				
		// Zombie/nemesis/assassin killed human, reward ammo packs
		if (g_zombie[attacker] && (g_zm_special[attacker] > 0 && !get_pcvar_num(cvar_zm_ignore_ammo[g_zm_special[attacker]])))
	...
	if (get_pcvar_num(cvar_deathmatch) || ((g_currentmode > MODE_LNJ) && (g_deathmatchmode > 0)))
	{
		...
		if(!g_zombie[victim] && !get_pcvar_num(cvar_hm_respawn[g_hm_special[victim]]) || g_zombie[victim] && !get_pcvar_num(cvar_zm_respawn[g_zm_special[victim]]))
			return;
...
public fw_TakeDamage(victim, inflictor, attacker, Float:damage, damage_type)
{
	...
	if (!g_zombie[attacker])
	{
		...
		// Reward ammo packs
		if (g_hm_special[attacker] <= 0 || (g_hm_special[attacker] > 0 && !get_pcvar_num(cvar_hm_ignore_ammo[g_hm_special[attacker]])))
		{
			// Store damage dealt
...
public fw_TakeDamage_Post(victim)
{
	...
	if (g_zombie[victim])
	{
		if (!get_pcvar_num(cvar_zm_painfree[g_zm_special[victim]]) && g_zm_special[victim] > 0) return;
		else {
...
public fw_TraceAttack(victim, attacker, Float:damage, Float:direction[3], tracehandle, damage_type)
{
	...
	for(new i = 1; i < MAX_SPECIALS_ZOMBIES; i++) 
	{
		if (g_zm_special[victim] == i && get_pcvar_float(cvar_zmsp_knockback[i]) == 0.0) 
			return HAM_IGNORED;
	}	
	...
	xs_vec_mul_scalar(direction, g_zm_special[victim] > 0 ? get_pcvar_float(cvar_zmsp_knockback[g_zm_special[victim]]) : g_zombie_knockback[victim], direction)
...
public fw_EmitSound(id, channel, const sample[], Float:volume, Float:attn, flags, pitch)
{
	...
	if (sample[7] == 'b' && sample[8] == 'h' && sample[9] == 'i' && sample[10] == 't')
	{
		...
		else if (g_zm_special[id] == DRAGON)
		{
...
public fw_PlayerPreThink(id)
{
	...
	else
	{
		if(g_user_custom_speed[id]) 
			...
			set_pev(id, pev_maxspeed, g_zm_special[id] > 0 ? g_zm_cached_spd[g_zm_special[id]] : g_zombie_spd[id])
		else 
	...
	{
		if(g_hm_special[id] <= 0 || !g_hm_cached_leap[g_hm_special[id]] && g_hm_special[id] > 0)
			return;
...
show_menu_extras(id)
{
	...
	// Title
	formatex(menu, charsmax(menu), "%L [%L]\r", id, "MENU_EXTRA_TITLE", id, g_zombie[id] ? zm_special_class_langs[g_zm_special[id]] : hm_special_class_langs[g_hm_special[id]])
	...
	for (item = 0; item < g_extraitem_i; item++)
	{
		...
		|| (g_zm_special[id] == BOMBARDIER && !(team & ZP_TEAM_BOMBARDIER)) || (g_hm_special[id] == SPY && !(team & ZP_TEAM_SPY)) || (g_zm_special[id] == DRAGON && !(team & ZP_TEAM_DRAGON))) 
			continue;
...
show_menu3_admin(id)
{
	...
	if (userflags & g_access_flag[ACCESS_RESPAWN_PLAYERS])
		len += formatex(menu[len], charsmax(menu) - len, "\r4.\w %L^n^n", id, "MENU_ADMIN4")
	else
		len += formatex(menu[len], charsmax(menu) - len, "\d4. %L^n^n", id, "MENU_ADMIN4")
		...
		switch (PL_ACTION)
		{
			case ACTION_ZOMBIEFY_HUMANIZE: // Zombiefy/Humanize command
			{
				if (g_zombie[player])
				{
					if (allowed_human(player) && (userflags & g_access_flag[ACCESS_MAKE_HUMAN]))
						formatex(menu, charsmax(menu), "%s %s[%L]", g_playername[player], g_zombie[player] ? "\r" : "\y", id, zm_special_class_langs[g_zm_special[player]])
					else
						formatex(menu, charsmax(menu), "\d%s [%L]", g_playername[player], id, zm_special_class_langs[g_zm_special[player]])
				}
				else
				{
					if (allowed_zombie(player) && (g_newround ? (userflags & g_access_flag[ACCESS_MODE_INFECTION]) : (userflags & g_access_flag[ACCESS_MAKE_ZOMBIE])))
						formatex(menu, charsmax(menu), "%s %s[%L]", g_playername[player], g_zombie[player] ? "\r" : "\y", id, hm_special_class_langs[g_hm_special[player]])
					else
						formatex(menu, charsmax(menu), "\d%s [%L]", g_playername[player], id, hm_special_class_langs[g_hm_special[player]])
				}
			}
			case ACTION_MAKE_NEMESIS: // Nemesis command
			{
				if (allowed_nemesis(player) && (g_newround ? (userflags & g_access_flag[ACCESS_MODE_NEMESIS]) : (userflags & g_access_flag[ACCESS_MAKE_NEMESIS])))
					formatex(menu, charsmax(menu), "%s %s[%L]", g_playername[player], g_zombie[player] ? "\r" : "\y", id, g_zombie[player] ? zm_special_class_langs[g_zm_special[player]] : hm_special_class_langs[g_hm_special[player]])
				else
					formatex(menu, charsmax(menu), "\d%s [%L]", g_playername[player], id, g_zombie[player] ? zm_special_class_langs[g_zm_special[player]] : hm_special_class_langs[g_hm_special[player]])
			}
			...
			{
				if (allowed_spy(player) && (g_newround ? (userflags & g_access_flag[ACCESS_MODE_SPY]) : (userflags & g_access_flag[ACCESS_MAKE_SPY])))
					formatex(menu, charsmax(menu), "%s %s[%L]", g_playername[player], g_zombie[player] ? "\r" : "\y", id, g_zombie[player] ? zm_special_class_langs[g_zm_special[player]] : hm_special_class_langs[g_hm_special[player]])
				else
					formatex(menu, charsmax(menu), "\d%s [%L]", g_playername[player], id, g_zombie[player] ? zm_special_class_langs[g_zm_special[player]] : hm_special_class_langs[g_hm_special[player]])
			}
	...
	switch (key)
	{
		...
		case 1: // Extra Items
		{
			...
			if (get_pcvar_num(cvar_extraitems))
			{
				...
				if(g_newround) zp_colored_print(id, "^x04[ZP]^x01 %L", id, "WAIT_ROUND_BEGINS")
...
buy_extra_item(id, itemid, ignorecost = 0)
{
	...
	if ((g_zombie[id] && g_zm_special[id] <= 0 && !(team & ZP_TEAM_ZOMBIE)) || (!g_zombie[id] && g_hm_special[id] <= 0 && !(team & ZP_TEAM_HUMAN)) || (g_zm_special[id] == NEMESIS && !(team & ZP_TEAM_NEMESIS))
	|| (g_hm_special[id] == SURVIVOR && !(team & ZP_TEAM_SURVIVOR)) || (g_hm_special[id] == SNIPER && !(team & ZP_TEAM_SNIPER)) || (g_hm_special[id] == BERSERKER && !(team & ZP_TEAM_BERSERKER)) 
	|| (g_hm_special[id] == WESKER && !(team & ZP_TEAM_WESKER)) || (g_hm_special[id] == SPY && !(team & ZP_TEAM_SPY)) || (g_zm_special[id] == ASSASSIN && !(team & ZP_TEAM_ASSASSIN)) 
	|| (g_zm_special[id] == PREDATOR && !(team & ZP_TEAM_PREDATOR)) || (g_zm_special[id] == BOMBARDIER && !(team & ZP_TEAM_BOMBARDIER)) || (g_zm_special[id] == DRAGON && !(team & ZP_TEAM_DRAGON)))
	{
		zp_colored_print(id, "^x04[ZP]^x01 %L", id, "CMD_NOT")
		return;
	}
	...
	|| (itemid >= EXTRA_WEAPONS_STARTID && itemid <= EXTRAS_CUSTOM_STARTID-1 && !get_pcvar_num(cvar_extraweapons)) || g_endround || g_newround)
	{
		zp_colored_print(id, "^x04[ZP]^x01 %L", id, "CMD_NOT")
		return;
	}
	...
	if (g_isconnected[playerid])
	{
		...
		switch (PL_ACTION)
		{
			...
			case ACTION_MAKE_SPY: // Spy command
			{
				...
				{
					if (allowed_spy(playerid))
						command_spy(id, playerid)
					else
						zp_colored_print(id, "^x04[ZP]^x01 %L", id, "CMD_NOT")
				}
				else
...
start_spy_mode(id, mode)
{
	...
	|| mode == MODE_SET)
	{
		...
		// Play spy sound
		ArrayGetString(sound_spy, random_num(0, ArraySize(sound_spy) - 1), sound, charsmax(sound))
		PlaySound(sound);
...
zombieme(id, infector, classid, silentmode, rewards)
{
	...
	if (!silentmode)
	{
		if (classid == NEMESIS)
		{
			...
			// Set health [0 = auto]
			if (get_pcvar_num(cvar_zm_health[NEMESIS]) == 0)
			{
				if (get_pcvar_num(cvar_zm_basehp[NEMESIS]) == 0)
					fm_set_user_health(id, ArrayGetCell(g_zclass_hp, 0) * fnGetAlive())
				else
					fm_set_user_health(id, get_pcvar_num(cvar_zm_basehp[NEMESIS]) * fnGetAlive())
			}
			else
				fm_set_user_health(id, get_pcvar_num(cvar_zm_health[NEMESIS]))
			
			// Set gravity, unless frozen
			if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_zmgravity[NEMESIS]))
		}
		...
		else if (classid == ASSASSIN)
		{
			...
			// Set health [0 = auto]
			if (get_pcvar_num(cvar_zm_health[ASSASSIN]) == 0)
			{
				if (get_pcvar_num(cvar_zm_basehp[ASSASSIN]) == 0)
					fm_set_user_health(id, ArrayGetCell(g_zclass_hp, 0) * fnGetAlive())
				else
					fm_set_user_health(id, get_pcvar_num(cvar_zm_basehp[ASSASSIN]) * fnGetAlive())
			}
			else
				fm_set_user_health(id, get_pcvar_num(cvar_zm_health[ASSASSIN]))
			
			// Set gravity, unless frozen
			if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_zmgravity[ASSASSIN]))
		}
		...
		else if (classid == PREDATOR)
		{
			...
			// Set health [0 = auto]
			if (get_pcvar_num(cvar_zm_health[PREDATOR]) == 0)
			{
				if (get_pcvar_num(cvar_zm_basehp[PREDATOR]) == 0)
					fm_set_user_health(id, ArrayGetCell(g_zclass_hp, 0) * fnGetAlive())
				else
					fm_set_user_health(id, get_pcvar_num(cvar_zm_basehp[PREDATOR]) * fnGetAlive())
			}
			else
				fm_set_user_health(id, get_pcvar_num(cvar_zm_health[PREDATOR]))
			
			// Set gravity, unless frozen
			if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_zmgravity[PREDATOR]))
		}
		...
		else if (classid == BOMBARDIER)
		{
			...
			// Set health [0 = auto]
			if (get_pcvar_num(cvar_zm_health[BOMBARDIER]) == 0)
			{
				if (get_pcvar_num(cvar_zm_basehp[BOMBARDIER]) == 0)
					fm_set_user_health(id, ArrayGetCell(g_zclass_hp, 0) * fnGetAlive())
				else
					fm_set_user_health(id, get_pcvar_num(cvar_zm_basehp[BOMBARDIER]) * fnGetAlive())
			}
			else fm_set_user_health(id, get_pcvar_num(cvar_zm_health[BOMBARDIER]))

				
			// Set gravity, unless frozen
			if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_zmgravity[BOMBARDIER]))
		...
		{
			// dragon
			g_zm_special[id] = DRAGON
			
			// Set health [0 = auto]
			if (get_pcvar_num(cvar_zm_health[DRAGON]) == 0)
			{
				if (get_pcvar_num(cvar_zm_basehp[DRAGON]) == 0)
					fm_set_user_health(id, ArrayGetCell(g_zclass_hp, 0) * fnGetAlive())
				else
					fm_set_user_health(id, get_pcvar_num(cvar_zm_basehp[DRAGON]) * fnGetAlive())
			}
			else fm_set_user_health(id, get_pcvar_num(cvar_zm_health[DRAGON]))

			// Set gravity, unless frozen
			if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_zmgravity[DRAGON]))
			
			// Dragon Skills Bot Suport
			if(g_isbot[id]) 
				set_task(random_float(5.0, 15.0), "use_cmd", id, _, _, "b")
			
			zp_colored_print(id, "^x04[ZP]^x01 %L", id, "DRAGON_INFO")
		}
	...
	// Nemesis aura task
	if (g_zm_special[id] > 0 && get_pcvar_num(cvar_zm_aura[g_zm_special[id]]))
		set_task(0.1, "zombie_aura", id+TASK_AURA, _, _, "b")
...
humanme(id, classid, silentmode)
{
	...
	if (classid == SURVIVOR)
	{
		...
		// Set Health [0 = auto]
		if (get_pcvar_num(cvar_hm_health[SURVIVOR]) == 0)
		{
			if (get_pcvar_num(cvar_hm_basehp[SURVIVOR]) == 0)
				fm_set_user_health(id, get_pcvar_num(cvar_hm_health[0]) * fnGetAlive())
			else
				fm_set_user_health(id, get_pcvar_num(cvar_hm_basehp[SURVIVOR]) * fnGetAlive())
		}
		else
			fm_set_user_health(id, get_pcvar_num(cvar_hm_health[SURVIVOR]))
		
		// Set gravity, unless frozen
		if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_hmgravity[SURVIVOR]))
		...
		if (get_pcvar_num(cvar_hm_aura[SURVIVOR]))
	...
	else if (classid == SNIPER)
	{
		...
		// Set Health [0 = auto]
		if (get_pcvar_num(cvar_hm_health[SNIPER]) == 0)
		{
			if (get_pcvar_num(cvar_hm_basehp[SNIPER]) == 0)
				fm_set_user_health(id, get_pcvar_num(cvar_hm_health[0]) * fnGetAlive())
			else
				fm_set_user_health(id, get_pcvar_num(cvar_hm_basehp[SNIPER]) * fnGetAlive())
		}
		else
			fm_set_user_health(id, get_pcvar_num(cvar_hm_health[SNIPER]))
		
		// Set gravity, unless frozen
		if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_hmgravity[SNIPER]))
		...
		if (get_pcvar_num(cvar_hm_aura[SNIPER]))
			set_task(0.1, "human_aura", id+TASK_AURA, _, _, "b")
	...
	else if (classid == BERSERKER)
	{
		...
		// Set Health [0 = auto]
		if (get_pcvar_num(cvar_hm_health[BERSERKER]) == 0)
		{
			if (get_pcvar_num(cvar_hm_basehp[BERSERKER]) == 0)
				fm_set_user_health(id, get_pcvar_num(cvar_hm_health[0]) * fnGetAlive())
			else
				fm_set_user_health(id, get_pcvar_num(cvar_hm_basehp[BERSERKER]) * fnGetAlive())
		}
		else
			fm_set_user_health(id, get_pcvar_num(cvar_hm_health[BERSERKER]))
		
		// Set gravity, unless frozen
		if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_hmgravity[BERSERKER]))
		...
		if (get_pcvar_num(cvar_hm_aura[BERSERKER]))
			set_task(0.1, "human_aura", id+TASK_AURA, _, _, "b")
	...
	else if (classid == WESKER)
	{
		...
		// Set Health [0 = auto]
		if (get_pcvar_num(cvar_hm_health[WESKER]) == 0)
		{
			if (get_pcvar_num(cvar_hm_basehp[WESKER]) == 0)
				fm_set_user_health(id, get_pcvar_num(cvar_hm_health[0]) * fnGetAlive())
			else
				fm_set_user_health(id, get_pcvar_num(cvar_hm_basehp[WESKER]) * fnGetAlive())
		}
		else
			fm_set_user_health(id, get_pcvar_num(cvar_hm_health[WESKER]))
		
		// Set gravity, unless frozen
		if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_hmgravity[WESKER]))
		...
		if (get_pcvar_num(cvar_hm_aura[WESKER]))
			set_task(0.1, "human_aura", id+TASK_AURA, _, _, "b")
	...
	else if (classid == SPY)
	{
		...
		// Set Health [0 = auto]
		if (get_pcvar_num(cvar_hm_health[SPY]) == 0)
		{
			if (get_pcvar_num(cvar_hm_basehp[SPY]) == 0)
				fm_set_user_health(id, get_pcvar_num(cvar_hm_health[0]) * fnGetAlive())
			else
				fm_set_user_health(id, get_pcvar_num(cvar_hm_basehp[SPY]) * fnGetAlive())
		}
		else
			fm_set_user_health(id, get_pcvar_num(cvar_hm_health[SPY]))
		
		// Set gravity, unless frozen
		if (!g_frozen[id]) set_pev(id, pev_gravity, get_pcvar_float(cvar_hmgravity[SPY]))
		
		// Give spy his own weapon and fill the ammo
		...
		// Give the spy a nice aura
		if (get_pcvar_num(cvar_hm_aura[SPY]))
			set_task(0.1, "human_aura", id+TASK_AURA, _, _, "b")
		
		// Spy bots will also need nightvision to see in the dark
		if (g_isbot[id])
		{
			g_nvision[id] = true
			cs_set_user_nvg(id, 1)
	...
	if (g_handle_models_on_separate_ent)
	{
		...
		{
			iRand = random_num(0, ArraySize(model_spy) - 1)
			ArrayGetString(model_spy, iRand, g_playermodel[id], charsmax(g_playermodel[]))
			if (g_set_modelindex_offset) fm_cs_set_user_model_index(id, ArrayGetCell(g_modelindex_spy, iRand))
		}
		else
		{
			if (get_pcvar_num(cvar_adminmodelshuman) && (get_user_flags(id) & g_access_flag[ACCESS_ADMIN_MODELS]))
	...
	else
	{
		...
		{
			size = ArraySize(model_spy)
			for (i = 0; i < size; i++)
			{
				ArrayGetString(model_spy, i, tempmodel, charsmax(tempmodel))
				if (equal(currentmodel, tempmodel)) already_has_model = true
			}
...
load_customization_from_files()
{
	...
	amx_load_setting_string(ZP_CUSTOMIZATION_FILE, "Access Flags", "START MODE DRAGON", user_access, charsmax(user_access)); g_access_flag[ACCESS_MODE_DRAGON] = read_flags(user_access)
	...
	amx_load_setting_string(ZP_CUSTOMIZATION_FILE, "Access Flags", "START MODE SPY", user_access, charsmax(user_access)); g_access_flag[ACCESS_MODE_SPY] = read_flags(user_access)
	...
	amx_load_setting_string(ZP_CUSTOMIZATION_FILE, "Access Flags", "MAKE DRAGON", user_access, charsmax(user_access)); g_access_flag[ACCESS_MAKE_DRAGON] = read_flags(user_access)
	...
	amx_load_setting_string(ZP_CUSTOMIZATION_FILE, "Access Flags", "MAKE SPY", user_access, charsmax(user_access)); g_access_flag[ACCESS_MAKE_SPY] = read_flags(user_access)
	...
	amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Player Models", "DRAGON", model_dragon)
	amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Player Models", "SPY", model_spy)
	...
	amx_load_setting_string(ZP_CUSTOMIZATION_FILE, "Weapon Models", "V_KNIFE DRAGON", model_vknife_dragon, charsmax(model_vknife_dragon))
	...
	amx_load_setting_string(ZP_CUSTOMIZATION_FILE, "Weapon Models", "V_M3 SPY", model_vm3_spy, charsmax(model_vm3_spy))
	amx_load_setting_string(ZP_CUSTOMIZATION_FILE, "Weapon Models", "P_M3 SPY", model_pm3_spy, charsmax(model_pm3_spy))
	...
	amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Sounds", "DRAGON PAIN", dragon_pain)
	...
	amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Sounds", "ROUND DRAGON", sound_dragon)
	amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Sounds", "ROUND WESKER", sound_wesker)
	amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Sounds", "ROUND SPY", sound_spy)
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_INFECTION]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "INFECTION SOUNDS", sound_ambience_infection)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "INFECTION DURATIONS", sound_ambience_infection_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_NEMESIS]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "NEMESIS SOUNDS", sound_ambience_nemesis)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "NEMESIS DURATIONS", sound_ambience_nemesis_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_SURVIVOR]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SURVIVOR SOUNDS", sound_ambience_survivor)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SURVIVOR DURATIONS", sound_ambience_survivor_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_SWARM]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SWARM SOUNDS", sound_ambience_swarm)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SWARM DURATIONS", sound_ambience_swarm_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_PLAGUE]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "PLAGUE SOUNDS", sound_ambience_plague)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "PLAGUE DURATIONS", sound_ambience_plague_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_SNIPER]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SNIPER SOUNDS", sound_ambience_sniper)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SNIPER DURATIONS", sound_ambience_sniper_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_ASSASSIN]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "ASSASSIN SOUNDS", sound_ambience_assassin)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "ASSASSIN DURATIONS", sound_ambience_assassin_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_LNJ]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "LNJ SOUNDS", sound_ambience_lnj)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "LNJ DURATIONS", sound_ambience_lnj_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_BERSERKER]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "BERSERKER SOUNDS", sound_ambience_berserker)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "BERSERKER DURATIONS", sound_ambience_berserker_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_PREDATOR]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "PREDATOR SOUNDS", sound_ambience_predator)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "PREDATOR DURATIONS", sound_ambience_predator_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_WESKER]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "WESKER SOUNDS", sound_ambience_wesker)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "WESKER DURATIONS", sound_ambience_wesker_dur)
	}
	...
	if (g_ambience_sounds[AMBIENCE_SOUNDS_BOMBARDIER]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "BOMBARDIER SOUNDS", sound_ambience_bombardier)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "BOMBARDIER DURATIONS", sound_ambience_bombardier_dur)
	}
	
	g_ambience_sounds[AMBIENCE_SOUNDS_SPY] = amx_load_setting_int(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SPY ENABLE", g_ambience_sounds[AMBIENCE_SOUNDS_SPY])
	if (g_ambience_sounds[AMBIENCE_SOUNDS_SPY]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SPY SOUNDS", sound_ambience_spy)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "SPY DURATIONS", sound_ambience_spy_dur)
	}
	
	g_ambience_sounds[AMBIENCE_SOUNDS_DRAGON] = amx_load_setting_int(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "DRAGON ENABLE", g_ambience_sounds[AMBIENCE_SOUNDS_DRAGON])
	if (g_ambience_sounds[AMBIENCE_SOUNDS_DRAGON]) {
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "DRAGON SOUNDS", sound_ambience_dragon)
		amx_load_setting_string_arr(ZP_CUSTOMIZATION_FILE, "Ambience Sounds", "DRAGON DURATIONS", sound_ambience_dragon_dur)
	}
...
public respawn_player_task(taskid)
{
	...
	if ((!g_endround && team != FM_CS_TEAM_SPECTATOR && team != FM_CS_TEAM_UNASSIGNED && !g_isalive[ID_SPAWN] && g_currentmode != MODE_SURVIVOR || get_pcvar_num(cvar_mod_allow_respawn[MODE_SURVIVOR])) && (g_currentmode != MODE_SWARM || get_pcvar_num(cvar_mod_allow_respawn[MODE_SWARM]))
	&& (g_currentmode != MODE_NEMESIS || get_pcvar_num(cvar_mod_allow_respawn[MODE_NEMESIS])) && (g_currentmode != MODE_PLAGUE || get_pcvar_num(cvar_mod_allow_respawn[MODE_PLAGUE])) && (g_currentmode != MODE_SNIPER || get_pcvar_num(cvar_mod_allow_respawn[MODE_SNIPER])) 
	&& (g_currentmode != MODE_ASSASSIN || get_pcvar_num(cvar_mod_allow_respawn[MODE_ASSASSIN])) && (g_currentmode != MODE_PREDATOR || get_pcvar_num(cvar_mod_allow_respawn[MODE_PREDATOR])) && (g_currentmode != MODE_BOMBARDIER || get_pcvar_num(cvar_mod_allow_respawn[MODE_BOMBARDIER]))
	&& (g_currentmode != MODE_DRAGON || get_pcvar_num(cvar_mod_allow_respawn[MODE_DRAGON])) && (g_currentmode != MODE_LNJ || get_pcvar_num(cvar_mod_allow_respawn[MODE_LNJ])) && (g_currentmode != MODE_BERSERKER || get_pcvar_num(cvar_mod_allow_respawn[MODE_BERSERKER])) 
	&& (g_currentmode != MODE_WESKER || get_pcvar_num(cvar_mod_allow_respawn[MODE_WESKER])) && (g_currentmode != MODE_SPY || get_pcvar_num(cvar_mod_allow_respawn[MODE_SPY])) && (!(g_currentmode > MODE_LNJ) || (g_deathmatchmode > 0)))
	{
...
public ambience_sound_effects(taskid)
{
	...
	static sound[64], iRand, duration, str_dur[32]
	...
	switch (g_currentmode)
	{
		case MODE_INFECTION:
		{
			iRand = random_num(0, ArraySize(sound_ambience_infection) - 1)
			ArrayGetString(sound_ambience_infection, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_infection_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_NEMESIS:
		{
			iRand = random_num(0, ArraySize(sound_ambience_nemesis) - 1)
			ArrayGetString(sound_ambience_nemesis, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_nemesis_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_ASSASSIN:
		{
			iRand = random_num(0, ArraySize(sound_ambience_assassin) - 1)
			ArrayGetString(sound_ambience_assassin, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_assassin_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_PREDATOR:
		{
			iRand = random_num(0, ArraySize(sound_ambience_predator) - 1)
			ArrayGetString(sound_ambience_predator, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_predator_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_BOMBARDIER:
		{
			iRand = random_num(0, ArraySize(sound_ambience_bombardier) - 1)
			ArrayGetString(sound_ambience_bombardier, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_bombardier_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_SURVIVOR:
		{
			iRand = random_num(0, ArraySize(sound_ambience_survivor) - 1)
			ArrayGetString(sound_ambience_survivor, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_survivor_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_SNIPER:
		{
			iRand = random_num(0, ArraySize(sound_ambience_sniper) - 1)
			ArrayGetString(sound_ambience_sniper, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_sniper_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_BERSERKER:
		{
			iRand = random_num(0, ArraySize(sound_ambience_berserker) - 1)
			ArrayGetString(sound_ambience_berserker, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_berserker_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_WESKER:
		{
			iRand = random_num(0, ArraySize(sound_ambience_wesker) - 1)
			ArrayGetString(sound_ambience_wesker, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_wesker_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_SPY:
		{
			iRand = random_num(0, ArraySize(sound_ambience_spy) - 1)
			ArrayGetString(sound_ambience_spy, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_spy_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_DRAGON:
		{
			iRand = random_num(0, ArraySize(sound_ambience_dragon) - 1)
			ArrayGetString(sound_ambience_dragon, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_dragon_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_SWARM:
		{
			iRand = random_num(0, ArraySize(sound_ambience_swarm) - 1)
			ArrayGetString(sound_ambience_swarm, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_swarm_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_MULTI:
		{
		...
		case MODE_PLAGUE:
		{
			iRand = random_num(0, ArraySize(sound_ambience_plague) - 1)
			ArrayGetString(sound_ambience_plague, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_plague_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
		case MODE_LNJ:
		{
			iRand = random_num(0, ArraySize(sound_ambience_lnj) - 1)
			ArrayGetString(sound_ambience_lnj, iRand, sound, charsmax(sound))
			ArrayGetString(sound_ambience_lnj_dur, iRand, str_dur, charsmax(str_dur))
			duration = str_to_num(str_dur)
		}
	...
	if (!g_isbot[id] && g_isconnected[id] && get_pcvar_num(cvar_aiminfo)) 
	{
		...
		if (g_zombie[id] == g_zombie[aimid])
		{
			...
			if (g_zombie[id]) {
				...
				formatex(class, charsmax(class), "%L %L", id, "CLASS_CLASS", id, zm_special_class_langs[g_zm_special[aimid]])
			}
			else {
				red = 0
				blue = 255
				
				formatex(class, charsmax(class), "%L %L", id, "CLASS_CLASS", id, hm_special_class_langs[g_hm_special[aimid]])
			}
	...
	switch (weaponid)
	{
		case CSW_KNIFE: // Custom knife models
		{
			if (g_zombie[id]) // Zombies
			{
				switch(g_zm_special[id])
				{
					...
					case DRAGON: set_pev(id, pev_viewmodel2, model_vknife_dragon)
					default: 
					{
						// Admin knife models?
		...
		case CSW_M3: // Spy's M3
		{
			if (g_hm_special[id] == SPY) {
				set_pev(id, pev_viewmodel2, model_vm3_spy)
				set_pev(id, pev_weaponmodel2, model_pm3_spy)
			}
...
public ShowHUD(taskid)
{
	...
	else
	{
		if(g_hud_type[ID_SHOWHUD] == 0)
		{
			...
			ShowSyncHudMsg(ID_SHOWHUD, g_MsgSync[1], "[%L: %d]^n[%L %s]^n[%L %d]^n[%L: %i]^n[%L: %d]^n[%L: %i]^n[%L: %d]^n[%L: %L]", id, "ZOMBIE_ATTRIB1", pev(ID_SHOWHUD, pev_health), ID_SHOWHUD, "CLASS_CLASS",
			class, ID_SHOWHUD, "AMMO_PACKS1", g_ammopacks[ID_SHOWHUD], id, "ZOMBIE_ATTRIB5", get_user_armor(id), id, "ZOMBIE_ATTRIB8", get_user_deaths(id), id, "ZOMBIE_ATTRIB7", get_user_frags(id), id, "ZOMBIE_ATTRIB2", fm_get_speed(id), id, "ZOMBIE_ATTRIB6", id, mode_names[g_Mode]);
		}
		...
		else if(g_hud_type[ID_SHOWHUD] == 3)
		{
			...
			ShowSyncHudMsg(ID_SHOWHUD, g_MsgSync[1], "[%s]^n[%L] [%d] - [%L] [%d]^n[%L] [%s] - [%L] [%d]^n[%L] [%L]",player_name, id, "ZOMBIE_ATTRIB1", get_user_health(ID_SHOWHUD), id, "ZOMBIE_ATTRIB5", get_user_armor(ID_SHOWHUD), ID_SHOWHUD, "CLASS_CLASS", class, ID_SHOWHUD, "AMMO_PACKS1", 
			g_ammopacks[ID_SHOWHUD], id, "CURRENT_MODE", id, mode_names[g_Mode])
		}
	}
}
...
fnGetDragon()
{
	...
	for (id = 1; id <= g_maxplayers; id++)
	{
		if (g_isalive[id] && g_zm_special[id] == DRAGON)
			iDragon++
	}
...
// Get Spys -returns alive spys number-
fnGetSpys()
{
	static iSpys, id
	iSpys = 0
	...
	for (id = 1; id <= g_maxplayers; id++)
	{
		if (g_isalive[id] && g_hm_special[id] == SPY)
			iSpys++
	}
...
// Checks if a player is allowed to be spy
allowed_spy(id)
{
	if (g_endround || g_hm_special[id] == SPY || !g_isalive[id] || task_exists(TASK_WELCOMEMSG) || (!g_newround && g_zombie[id] && fnGetZombies() == 1))
		return false;
...
allowed_dragon(id)
{
	if (g_endround || g_zm_special[id] == DRAGON || !g_isalive[id] || task_exists(TASK_WELCOMEMSG) || (!g_newround && !g_zombie[id] && fnGetHumans() == 1))
		return false;
...
command_predator(id, player)
{
	...
	switch (get_pcvar_num(cvar_showactivity))
	{
		case 1: client_print(0, print_chat, "ADMIN - %s %L", g_playername[player], LANG_PLAYER, "CMD_PREDATOR")
		case 2: client_print(0, print_chat, "ADMIN %s - %s %L", g_playername[id], g_playername[player], LANG_PLAYER, "CMD_PREDATOR")
	}
...
command_wesker(id, player)
{
	...
	switch (get_pcvar_num(cvar_showactivity))
	{
		case 1: client_print(0, print_chat, "ADMIN - %s %L", g_playername[player], LANG_PLAYER, "CMD_WESKER")
		case 2: client_print(0, print_chat, "ADMIN %s - %s %L", g_playername[id], g_playername[player], LANG_PLAYER, "CMD_WESKER")
	}
...
command_spy(id, player)
{
	...
	switch (get_pcvar_num(cvar_showactivity))
	{
		case 1: client_print(0, print_chat, "ADMIN - %s %L", g_playername[player], LANG_PLAYER, "CMD_SPY")
		case 2: client_print(0, print_chat, "ADMIN %s - %s %L", g_playername[id], g_playername[player], LANG_PLAYER, "CMD_SPY")
	}
	...
	if (get_pcvar_num(cvar_logcommands))
	{
		...
		get_user_authid(id, authid, charsmax(authid))
		get_user_ip(id, ip, charsmax(ip), 1)
		formatex(logdata, charsmax(logdata), "ADMIN %s <%s><%s> - %s %L (Players: %d/%d)", g_playername[id], authid, ip, g_playername[player], LANG_SERVER,"CMD_SPY", fnGetPlaying(), g_maxplayers)
		log_to_file("zombie_plague_special.log", logdata)
	}
...
public native_get_extra_item_name(plugin_id, param_nums)
{
	...
	switch (itemid)
	{
		case EXTRA_NVISION: formatex(buffer, charsmax(buffer), "%L", LANG_PLAYER, "MENU_EXTRA1")
		case EXTRA_ANTIDOTE: formatex(buffer, charsmax(buffer), "%L", LANG_PLAYER, "MENU_EXTRA2")
		case EXTRA_MADNESS: formatex(buffer, charsmax(buffer), "%L", LANG_PLAYER, "MENU_EXTRA3")
		case EXTRA_INFBOMB: formatex(buffer, charsmax(buffer), "%L", LANG_PLAYER, "MENU_EXTRA4")
		default: ArrayGetString(g_extraitem_name, itemid, buffer, charsmax(buffer))
	}
...
public Float:native_get_user_maxspeed(id)
{
	...
	if (g_zombie[id])
		return (g_zm_special[id] > 0 ? g_zm_cached_spd[g_zm_special[id]] : g_zombie_spd[id])
...
public native_set_user_frozen(id, set)
{
	...
	if(set)
	{
		...
		if (g_zm_special[id] > 0 && g_zm_special[id] < MAX_SPECIALS_ZOMBIES || g_hm_special[id] > 0 && g_hm_special[id] < MAX_SPECIALS_HUMANS)
		{
			// Get player's origin
			static origin2[3]
			get_user_origin(id, origin2)
...
public native_set_user_burn(id, set)
{
	...
	if(set)
	{
		...
		if (g_zm_special[id] > 0 && g_zm_special[id] < MAX_SPECIALS_ZOMBIES || g_hm_special[id] > 0 && g_hm_special[id] < MAX_SPECIALS_HUMANS) // fire duration (nemesis/assassin is fire resistant)
...
public set_user_flashlight(taskid)
{
	...
	write_byte(get_pcvar_num(g_currentmode == MODE_ASSASSIN ? cvar_flashsize2 : cvar_flashsize)) // radius
...
public turn_invisible(id) 
{
	...
	{
		if(get_pcvar_num(cvar_zm_glow[PREDATOR])) fm_set_rendering(g_handle_models_on_separate_ent ? g_ent_playermodel[id] : id, kRenderFxGlowShell, get_pcvar_num(cvar_zm_red[PREDATOR]), get_pcvar_num(cvar_zm_green[PREDATOR]), get_pcvar_num(cvar_zm_blue[PREDATOR]), kRenderTransAlpha, 20)
		else fm_set_rendering(g_handle_models_on_separate_ent ? g_ent_playermodel[id] : id, kRenderFxGlowShell, 0, 0, 0, kRenderTransAlpha, 20)
	}
	
	if(g_hm_special[id] == SPY)
	{
		if(get_pcvar_num(cvar_hm_glow[SPY])) fm_set_rendering(g_handle_models_on_separate_ent ? g_ent_playermodel[id] : id, kRenderFxGlowShell, get_pcvar_num(cvar_hm_red[SPY]), get_pcvar_num(cvar_hm_green[SPY]), get_pcvar_num(cvar_hm_blue[SPY]), kRenderTransAlpha, 10)
		else fm_set_rendering(g_handle_models_on_separate_ent ? g_ent_playermodel[id] : id, kRenderFxGlowShell, 0, 0, 0, kRenderTransAlpha, 10)
	}
}
...
{
	new szText[555]
	formatex(szText, charsmax(szText), "%L", id, "MENU_CHOOSE_HUD_COLOR_TITLE1")
	new menu = menu_create(szText, "menu_hud_zm_color_handler")
	
	formatex(szText, charsmax(szText), "%L", id, "MENU_PERSONAL_COLOR1")
	menu_additem(menu, szText, "1", 0)
	formatex(szText, charsmax(szText), "%L", id, "MENU_PERSONAL_COLOR2")
	menu_additem(menu, szText, "2", 0)
	formatex(szText, charsmax(szText), "%L", id, "MENU_PERSONAL_COLOR3")
	menu_additem(menu, szText, "3", 0)
	formatex(szText, charsmax(szText), "%L", id, "MENU_PERSONAL_COLOR4")
	menu_additem(menu, szText, "4", 0)
	formatex(szText, charsmax(szText), "%L", id, "MENU_PERSONAL_COLOR5")
	menu_additem(menu, szText, "5", 0)
	formatex(szText, charsmax(szText), "%L", id, "MENU_PERSONAL_COLOR6")
	menu_additem(menu, szText, "6", 0)
	formatex(szText, charsmax(szText), "%L", id, "MENU_PERSONAL_COLOR7")
...
{
	new szText[555]
	formatex(szText, charsmax(szText), "%L", id, "MENU_CHOOSE_HUD_COLOR_TITLE2")
	new menu = menu_create(szText, "menu_hud_hm_color_handler")
...
{
	new szText[555]
	formatex(szText, charsmax(szText), "%L", id, "MENU_NVISION_COLOR_TITLE1")
	new menu = menu_create(szText, "menu_night_hm_color_handler")
...
{
	new szText[555]
	formatex(szText, charsmax(szText), "%L", id, "MENU_NVISION_COLOR_TITLE2")
	new menu = menu_create(szText, "menu_night_zm_color_handler")
...
public reset_user_rendering(id)
{
	...
	{
		// Light blue glow while frozen
		fm_set_rendering(ent_id, kRenderFxGlowShell, 0, 100, 200, kRenderNormal, 25)
	}	
	else if (g_zombie[id])
	{
		if (g_zm_special[id] <= 0)
			...
			if(get_pcvar_num(cvar_zm_glow[g_zm_special[id]]))
				fm_set_rendering(ent_id, kRenderFxGlowShell, get_pcvar_num(cvar_zm_red[g_zm_special[id]]), get_pcvar_num(cvar_zm_green[g_zm_special[id]]), get_pcvar_num(cvar_zm_blue[g_zm_special[id]]), g_zm_special[id] == PREDATOR ? kRenderTransAlpha : kRenderNormal, 20)
			else
				fm_set_rendering(ent_id, kRenderFxGlowShell, 0, 0, 0, g_zm_special[id] == PREDATOR ? kRenderTransAlpha : kRenderNormal, 20)
		}
	}
	else
	{
		if (g_hm_special[id] <= 0)
			...
			if(get_pcvar_num(cvar_hm_glow[g_hm_special[id]]))
				fm_set_rendering(ent_id, kRenderFxGlowShell, get_pcvar_num(cvar_hm_red[g_hm_special[id]]), get_pcvar_num(cvar_hm_green[g_hm_special[id]]), get_pcvar_num(cvar_hm_blue[g_hm_special[id]]), g_hm_special[id] == SPY ? kRenderTransAlpha : kRenderNormal, g_hm_special[id] == SPY ? 10 : 20)
			else
				fm_set_rendering(ent_id, kRenderFxGlowShell, 0, 0, 0, g_hm_special[id] == SPY ? kRenderTransAlpha : kRenderNormal, g_hm_special[id] == SPY ? 10 : 20)
		}
	}
}
