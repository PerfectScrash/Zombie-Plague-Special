...
// Variables
new g_gameid, g_maxplayers, cvar_minplayers, cvar_ratio, cvar_weskerhp, cvar_alienhp, g_msg_sync
...
public plugin_init()
{
	...
	register_plugin("[ZP] Synapsis Mode","1.0", "@bdul! | [P]erfec[T] [S]cr[@]s[H]")
...
public plugin_precache()
{
	...
	{
		for (i = 0; i < sizeof g_sound_synapsis; i++)
	...
	{
		for (i = 0; i < sizeof g_sound_amb_synapsis_duration; i++)
